  ...
  const renderAppActionButton = (app) => {
    ...
    if (state && state.status === "downloading") {
      ...
      const strokeDashoffset =
        circumference - (state.progress / 100) * circumference;
            ...
            <nav className="space-y-0.5">
              {[
                ...
                },
                {
                  id: "play",
                  label: "Play Games",
                  icon: <PlayIcon className="w-4 h-4 fill-current" />,
                },
                {
                  id: "develop",
                  label: "Work & Develop",
                  ...
                  {FEATURED_APPS.map((item) => (
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-white/70 max-w-xs mt-1 line-clamp-2">
                          {item.desc}
                        </p>
                      </div>
                      <div className="flex items-center justify-between pt-4">
                        ...
                        <button
                          onClick={() =>
                            handleOpenApp(
                              STORE_APPS.find((app) => app.id === item.id),
                            )
                          }
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">
                    Keep your tools updated for the latest system stability
                    enhancements.
                  </p>
                </div>
                <button
                ...
                {[
                  {
                    ...
                    ver: "v116.4.2",
                    details:
                      "Improves responsiveness of layout resizing and resolves vector rendering glitches.",
                  },
                  {
                    id: "vscode",
                    name: "VS Code",
                    ver: "v1.94.0",
                    details:
                      "Adds typescript syntax compiler accelerators and optimizes window redraw load times.",
                  },
                  {
                    id: "slack",
                    name: "Slack",
                  ...
                  const isUpdating =
                    progressVal !== undefined && progressVal < 100;
          ...
          <div className="w-full max-w-[320px] bg-white rounded-2xl shadow-2xl border border-black/10 p-5 text-center flex flex-col items-center gap-4 animate-fade-in">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-gray-400 leading-relaxed">
                {alertApp.name} is successfully installed on your desktop! You
                can now access and run it via custom command simulations inside
