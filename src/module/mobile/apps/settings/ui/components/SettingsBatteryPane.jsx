...
import { Battery, BatteryCharging, ChevronRight, Activity, Zap } from "lucide-react";
  ...
  return (
    <div className="w-full px-4 py-6 space-y-5 select-none animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="bg-white rounded-2xl border border-black/5 overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
        <div className="flex justify-between items-center p-3.5 pl-4 hover:bg-zinc-50 cursor-pointer active:bg-zinc-50 transition-colors">
      ...
      <div className="pt-2">
        ...
        <div className="bg-white rounded-2xl border border-black/5 overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.02)] divide-y divide-zinc-100">
          <div className="flex items-center justify-between p-3.5 pl-4">
            ...
            <span className="text-[15px] font-medium text-gray-500">34%</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3.5 pl-4">
            ...
            <span className="text-[15px] font-medium text-gray-500">22%</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3.5 pl-4">
            ...
            <span className="text-[15px] font-medium text-gray-500">14%</span>
          </div>
        </div>
      </div>
