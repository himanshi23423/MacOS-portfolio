...
const MobileOSControlCenter = ({
  ...
  useEffect(() => {
    ...
    if (isControlOpen) {
      gsap.fromTo(
        ...
        { y: "0%", opacity: 1, pointerEvents: "auto", duration: 0.45, ease: "power4.out" },
      );
    } else {
  ...
  return (
    ...
    >
      <div className="bg-[rgba(10,10,12,0.78)] backdrop-blur-[45px] backdrop-saturate-[2.1] min-h-dvh pt-[55px] pb-10 px-5 flex flex-col gap-4 select-none relative overflow-y-auto">
        ...
        <div className="flex items-center justify-between mt-2 mb-1 z-10">
        ...
        {/* Page Container */}
        <div className="flex-1 w-full z-10 flex flex-col justify-start">
