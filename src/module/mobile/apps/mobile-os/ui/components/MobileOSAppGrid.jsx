...
const MobileOSAppGrid = ({ dockApps, openWindow }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* PAGE 1: Widgets (Top) + Primary App Grid (Bottom-aligned) */}
            ...
            <div className="bg-gradient-to-b from-[#3a86f5] via-[#2068e6] to-[#0d4eb5] rounded-[22px] p-3 flex flex-col justify-between shadow-[0_6px_20px_rgba(0,0,0,0.22)] border border-white/12 text-white">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-x-1 gap-y-1 mt-1.5 pt-1.5 border-t border-white/10 text-[8px] text-white/80 font-medium">
                  ...
                  <div className="col-span-2 text-sky-200/90 font-semibold tracking-wide mt-0.5">
                    AQI {activeCity.aqi} • {activeCity.aqiLabel}
                  </div>
                </div>
              </div>
            </div>

            {/* iOS 17 Premium Battery Widget (Responsive 4 Accessory Grid) */}
            <div className="bg-[#1c1c1e]/90 backdrop-blur-xl rounded-[22px] p-3 flex flex-col justify-between shadow-[0_6px_20px_rgba(0,0,0,0.22)] border border-white/[0.08] text-white">
              <span className="text-[8.5px] font-bold text-white/40 tracking-wider uppercase">
                Batteries
              </span>
              ...
              <div className="grid grid-cols-2 gap-y-2 gap-x-1.5 my-auto">
                ...
                <div className="flex items-center gap-1.5 pl-0.5 min-w-0">
                  <div className="relative w-[28px] h-[28px] xs:w-[32px] xs:h-[32px] flex items-center justify-center flex-shrink-0">
                    ...
                    <Smartphone size={9} className="text-white/90 xs:size-[10px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] xs:text-[9.5px] font-bold leading-none">88%</p>
                    <p className="text-[7px] xs:text-[8px] text-white/40 font-medium truncate mt-0.5">
                      iPhone
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 min-w-0">
                  <div className="relative w-[28px] h-[28px] xs:w-[32px] xs:h-[32px] flex items-center justify-center flex-shrink-0">
                    ...
                    <Watch size={9} className="text-white/90 xs:size-[10px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] xs:text-[9.5px] font-bold leading-none">94%</p>
                    <p className="text-[7px] xs:text-[8px] text-white/40 font-medium truncate mt-0.5">
                      Watch
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-1.5 pl-0.5 min-w-0">
                  <div className="relative w-[28px] h-[28px] xs:w-[32px] xs:h-[32px] flex items-center justify-center flex-shrink-0">
                    ...
                    <Headphones size={9} className="text-white/90 xs:size-[10px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] xs:text-[9.5px] font-bold leading-none">100%</p>
                    <p className="text-[7px] xs:text-[8px] text-white/40 font-medium truncate mt-0.5">
                      AirPods
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-1.5 min-w-0">
                  <div className="relative w-[28px] h-[28px] xs:w-[32px] xs:h-[32px] flex items-center justify-center flex-shrink-0">
                    ...
                    <Laptop size={9} className="text-white/90 xs:size-[10px]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] xs:text-[9.5px] font-bold leading-none">65%</p>
                    <p className="text-[7px] xs:text-[8px] text-white/40 font-medium truncate mt-0.5">
                      MacBook
                    </p>
                  </div>
