    ...
    <>
      ...
      >
        <div style={{ padding: "24px 20px 0" }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, color: "#000", marginBottom: 16 }}>
            Favorites
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {socials.map((favorite) => (
              ...
              >
                ...
                <span
                  style={{ fontSize: 11, fontWeight: 500, color: "#3c3c43", textAlign: "center" }}
                >
                  {favorite.id === 1
                    ? "Github"
                    : favorite.id === 2
        ...
        <div style={{ padding: "20px 20px 32px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {projects.map((project) => (
              <div
                key={project.id}
                style={{ background: "#f2f2f7", borderRadius: 14, overflow: "hidden" }}
              >
                ...
                <div style={{ padding: 14 }}>
                  <h3 style={{ fontSize: 17, fontWeight: 600, color: "#000", marginBottom: 6 }}>
                    {project.title}
                  </h3>
                  <p
                    style={{
