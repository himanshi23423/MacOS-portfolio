...
import {
  Search, Globe, AlertTriangle, ArrowRight, Bookmark, Settings, Star, History, Info
} from "lucide-react";
            ...
            <div className="px-6 pb-6 relative">
              ...
              <div className="pt-20 space-y-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Mumbai, Maharashtra, India &bull; <a href="https://www.linkedin.com/in/kuldeepdotcom/" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline">Contact info</a></p>
                </div>
