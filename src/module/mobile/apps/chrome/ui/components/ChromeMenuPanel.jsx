      ...
      >
        <div className="pb-1.5">
          ...
          >
            ...
            <span>
              {isDefaultBrowser ? "Chrome is default browser" : "Set Chrome as default browser"}
            </span>
          </button>
        </div>
          ...
          >
            ...
            {activeSubMenu === "profile" && (
              ...
              >
                ...
                <button
                  onClick={() => {
                    const n = prompt("Enter new username:", username);
                    if (n) setUsername(n);
                    setActiveSubMenu(null);
                    setIsMenuOpen(false);
                  }}
          ...
          >
            ...
            {activeSubMenu === "tabgroups" && (
              ...
              >
                <button
                  onClick={() => {
                    const g = prompt("Enter new tab group name:", "Work");
                    if (g) alert(`Created tab group "${g}"!`);
                    setActiveSubMenu(null);
                    setIsMenuOpen(false);
                  }}
                  className={`w-full text-left px-3 py-1.5 rounded-md ${menuThemeClasses.itemHover}`}
                ...
                <button
                  onClick={async () => {
                    try {
                      ...
                      setAddressInput(t);
                      alert(`Pasted text from clipboard: "${t}"`);
                    } catch {
              ...
              >
                ...
                <button
                  onClick={() => {
                    ...
                    setDownloadsList((prev) => [nd, ...prev]);
                    alert(`Saved Page: Added "${nd.name}" to Downloads list.`);
                    setIsMenuOpen(false);
                  }}
                  className={`w-full text-left px-3 py-1.5 rounded-md ${menuThemeClasses.itemHover}`}
                >
