        ...
        <div className="grid grid-cols-5 gap-6 max-w-lg w-full justify-center text-center mt-2">
          {bookmarks.slice(0, 5).map((bookmark, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-11 h-11 rounded-full border flex items-center justify-center shadow-sm overflow-hidden transition-all group-hover:scale-105 ${
                    theme === "dark"
                ...
                <span
                  className={`text-[10px] font-semibold group-hover:underline truncate w-16 ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}
                >
                  {bookmark.title}
                </span>
              </button>
