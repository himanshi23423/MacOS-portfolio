  ...
  <div className="flex-1 flex flex-col bg-white p-5 md:p-6 overflow-y-auto">
    {activeNote ? (
      <textarea
        ...
        className="flex-1 w-full bg-transparent text-base resize-none border-none outline-none focus:ring-0 focus:outline-none font-sans leading-relaxed text-gray-800 caret-[#ff9f0a]"
      />
    ) : (
