...
const VSCodeAboutModal = ({ show, onClose }) => {
  if (!show) return null;
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-3 text-center">
          ...
          />
          <h1 className="text-base font-bold text-gray-900 mt-3 select-none">Visual Studio Code</h1>
          <p className="text-[10px] text-gray-500 font-medium select-none mt-0.5">
            Version 1.96.2 (Universal)
          </p>
          <p className="text-[9px] text-gray-400 font-medium select-none mt-0.5">
        ...
        <div className="text-center text-[8.5px] text-gray-400/90 leading-tight mb-2 select-none">
          <p>Copyright © 2024-2026 Microsoft Corp.</p>
...
export default VSCodeAboutModal;
