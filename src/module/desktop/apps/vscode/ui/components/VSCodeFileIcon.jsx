...
export const FolderIcon = ({ isOpen = false, size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    {isOpen ? (
      <>
        <path d="M1.5 3C1.5 2.44772 1.94772 2 2.5 2H6L7.5 3.5H13.5C14.0523 3.5 14.5 3.94772 14.5 4.5V5H3L1.5 12V3Z" fill="#dcb67a" />
        <path d="M2.5 5.5H14L12.5 12.5H1L2.5 5.5Z" fill="#e8c97a" />
      </>
    ) : (
      <path d="M1.5 3C1.5 2.44772 1.94772 2 2.5 2H6L7.5 3.5H13.5C14.0523 3.5 14.5 3.94772 14.5 4.5V12C14.5 12.5523 14.0523 13 13.5 13H2.5C1.94772 13 1.5 12.5523 1.5 12V3Z" fill="#dcb67a" />
    )}
  </svg>
);
...
const ReactIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <ellipse cx="8" cy="8" rx="6.5" ry="2.5" stroke="#61dafb" strokeWidth="0.8" fill="none" transform="rotate(60 8 8)" />
    <ellipse cx="8" cy="8" rx="6.5" ry="2.5" stroke="#61dafb" strokeWidth="0.8" fill="none" transform="rotate(120 8 8)" />
  </svg>
);
...
const JSIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="8" y="12" textAnchor="middle" fill="#323330" fontSize="8" fontWeight="bold" fontFamily="monospace">JS</text>
  </svg>
);
...
const TSIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="8" y="12" textAnchor="middle" fill="#ffffff" fontSize="8" fontWeight="bold" fontFamily="monospace">TS</text>
  </svg>
);
...
const CSSIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="8" y="11.5" textAnchor="middle" fill="#ffffff" fontSize="6.5" fontWeight="bold" fontFamily="monospace">{"{}"}</text>
  </svg>
);
...
const MDIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="8" y="12" textAnchor="middle" fill="#ffffff" fontSize="8" fontWeight="bold" fontFamily="monospace">M</text>
  </svg>
);
...
const ConfigIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8 4L10.5 6L10.5 10L8 12L5.5 10L5.5 6L8 4Z" stroke="#ffffff" strokeWidth="1" fill="none" />
