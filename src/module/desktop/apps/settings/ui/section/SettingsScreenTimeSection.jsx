...
import { Hourglass, Lock, Eye, ArrowLeft, ToggleLeft, ToggleRight, ShieldAlert, ShieldCheck, ChevronRight, Info, AlertTriangle, Monitor, Calendar } from "lucide-react";
...
const SettingsScreenTimeSection = () => {
  ...
  const totalMinutes = currentDayData.dev + currentDayData.prod + currentDayData.other;

  const appUsage = [
    { name: "VS Code", category: "Development", time: "4h 10m", percentage: 65, icon: "💻" },
    { name: "Safari / Chrome", category: "Productivity", time: "1h 50m", percentage: 28, icon: "🌐" },
      ...
      <div className="max-w-2xl mx-auto p-8 animate-in fade-in slide-in-from-left-2 duration-200">
        ...
        <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-gray-150">
          ...
          <div>
            ...
            <p className="text-[11.5px] text-gray-400 font-semibold mt-0.5">Schedule time away from the screen</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm flex justify-between items-center text-xs text-gray-700">
          <div>
            ...
            <span className="text-[10.5px] text-gray-400 font-semibold block mt-0.5">Only allowed apps and calls will be available</span>
          </div>
          <button 
        ...
        {downtimeEnabled && (
          <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm space-y-4 text-xs text-gray-700 animate-in fade-in duration-200">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-gray-700 font-semibold bg-gray-100 px-2 py-0.5 rounded border border-gray-200">22:00 - 07:00</span>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="max-w-2xl mx-auto p-8 animate-in fade-in slide-in-from-left-2 duration-200">
        ...
        <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-gray-150">
          ...
          <div>
            ...
            <p className="text-[11.5px] text-gray-400 font-semibold mt-0.5">Set daily time limits for app categories</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm flex justify-between items-center text-xs text-gray-700">
          <div>
            ...
            <span className="text-[10.5px] text-gray-400 font-semibold block mt-0.5">Block apps when limits are reached</span>
          </div>
          <button 
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm space-y-4 text-xs text-gray-700 animate-in fade-in duration-200">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono text-gray-600 font-semibold">{developerLimit} Hours</span>
              </div>
              <input 
                type="range"
                min="1"
    ...
    return (
      <div className="max-w-2xl mx-auto p-8 animate-in fade-in slide-in-from-left-2 duration-200">
        ...
        <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-gray-150">
          ...
          <div>
            <h2 className="text-base font-extrabold text-gray-900 leading-tight">Content & Privacy</h2>
            <p className="text-[11.5px] text-gray-400 font-semibold mt-0.5">Restrict web content, downloads, and app settings</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm flex justify-between items-center text-xs text-gray-700">
          <div>
            ...
            <span className="text-[10.5px] text-gray-400 font-semibold block mt-0.5">Toggle content constraints</span>
          </div>
          <button 
        ...
        {privacyEnabled ? (
          <div className="bg-green-50/40 border border-green-200 p-4 rounded-xl flex items-start gap-2.5 text-xs text-green-700 animate-in fade-in duration-200">
            ...
            <div>
              ...
              <span className="font-medium block mt-0.5">Adult content filtering, private window limitations, and mock security protocols are now actively enforced.</span>
            </div>
          </div>
        ) : (
          <div className="bg-yellow-50/40 border border-yellow-200 p-4 rounded-xl flex items-start gap-2.5 text-xs text-yellow-700 animate-in fade-in duration-200">
            ...
            <div>
              ...
              <span className="font-medium block mt-0.5">Content, privacy limits, and restricted system modifications are currently bypassed on this Mac.</span>
            </div>
          </div>
        )}
      </div>
    ...
    <div className="max-w-2xl mx-auto p-8 animate-in fade-in slide-in-from-bottom-2 duration-300 space-y-6">
      ...
      <div className="w-full bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-[11px] text-gray-400 font-semibold mt-0.5">
              {selectedDay === "Thu" ? "Today, " : ""}Selected: {selectedDay} (Average: {dailyAverage})
            </p>
          </div>
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] mt-1.5 font-bold ${
                  isSelected ? "text-blue-500 font-extrabold" : "text-gray-400 group-hover:text-gray-600"
                }`}>
                  {day}
                </span>
              </div>
        ...
        <div className="flex justify-between text-[11px] font-semibold text-gray-500 border-t border-gray-100 pt-3">
          <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-full bg-blue-500" /><span className="text-gray-700">Development</span></div>
          <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-full bg-indigo-400" /><span className="text-gray-700">Productivity</span></div>
          <div className="flex items-center gap-1.5"><div className="w-2.5 h-2.5 rounded-full bg-cyan-400" /><span className="text-gray-700">Other</span></div>
        </div>
      </div>

      {/* Screen Time Utilities Option lists */}
      <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider ml-1 mb-2">Controls</h3>
      <div className="w-full bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm divide-y divide-gray-100">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[13px] font-bold text-gray-900 block leading-tight">Downtime</span>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[13px] font-bold text-gray-900 block leading-tight">App Limits</span>
              <span className="text-[10px] text-gray-400 font-semibold block leading-tight mt-0.5">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[13px] font-bold text-gray-900 block leading-tight">Content & Privacy</span>
              <span className="text-[10px] text-gray-400 font-semibold block leading-tight mt-0.5">
      ...
      <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider ml-1 mb-2">Most Used Apps</h3>
      <div className="w-full bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm divide-y divide-gray-100">
        {appUsage.map((app) => (
          <div key={app.name} className="flex justify-between items-center p-3.5 px-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[13px] font-bold text-gray-800 block leading-tight">{app.name}</span>
                <span className="text-[10px] text-gray-400 font-semibold block leading-tight mt-0.5">{app.category}</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-[12px] font-mono font-semibold text-gray-500 text-right w-12">{app.time}</span>
            </div>
          </div>
        ))}
      </div>
