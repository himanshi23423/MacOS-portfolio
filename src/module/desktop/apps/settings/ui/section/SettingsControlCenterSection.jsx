...
import { 
  Wifi, Bluetooth, AppWindow, Airplay, Moon, 
  Monitor, Volume2, Music, Accessibility, 
  Battery, Users, Sliders
} from "lucide-react";
...
const SettingsControlCenterSection = () => {
  ...
  // Reusable Select component for Menu Bar options
  ...
  const Toggle = ({ active, onChange }) => (
    ...
    >
      <span className={`w-5 h-5 rounded-full bg-white absolute top-0.5 shadow-md transition-all ${active ? "left-[18px]" : "left-0.5"}`} />
    </button>
  );
    ...
    <div className="max-w-2xl mx-auto p-6 @sm:p-8 animate-in fade-in slide-in-from-bottom-2 duration-300 relative select-none">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400 font-semibold mt-0.5">Modules always show in Control Center. You can also show them in the menu bar.</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          <h3 className="text-[12px] font-bold text-gray-400 uppercase tracking-wider ml-1 mb-2">Control Center Modules</h3>
        ...
        {/* Other Modules */}
        <div>
          <h3 className="text-[12px] font-bold text-gray-400 uppercase tracking-wider ml-1 mb-2">Other Modules</h3>
          <p className="text-[11px] text-gray-400 font-semibold mb-3 ml-1">You can choose to show these modules in Control Center or the menu bar.</p>
          ...
          <div className="w-full bg-gray-50 rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <div className="flex flex-col p-4 border-b border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[13px] font-bold text-gray-900 block">Accessibility Shortcuts</span>
              </div>
            ...
            <div className="flex flex-col p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[13px] font-bold text-gray-900 block">Fast User Switching</span>
              </div>
              <div className="flex items-center justify-between pl-11 pr-2">
                <span className="text-[12px] text-gray-700">Show in Control Center</span>
