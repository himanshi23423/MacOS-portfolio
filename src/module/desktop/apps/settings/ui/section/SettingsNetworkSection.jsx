          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {connectingInterface === "thunderbolt" && <Loader2 size={13} className="animate-spin text-[#007aff]" />}
              </div>
            </div>
            <span className={`text-[12px] font-medium ${thunderbolt ? "text-[#007aff]" : "text-gray-500"}`}>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {connectingInterface === "vpn" && <Loader2 size={13} className="animate-spin text-[#007aff]" />}
              </div>
            </div>
            <div className="flex items-center gap-2 text-right">
              ...
              <span className={`text-[12px] font-medium ${vpn ? "text-[#007aff]" : "text-gray-500"}`}>
      ...
      {promptType === "thunderbolt" && (
        <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-gray-200 rounded-xl shadow-2xl p-5 w-80 max-w-full text-center select-none animate-in zoom-in-95 duration-200">
            ...
            <h4 className="text-[14px] font-bold text-gray-900 leading-tight">Connect Thunderbolt Bridge</h4>
      ...
      {promptType === "vpn_config" && (
        <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-gray-200 rounded-xl shadow-2xl p-5 w-80 max-w-full text-center select-none animate-in zoom-in-95 duration-200">
            ...
            <p className="text-[11px] text-gray-500 mt-0.5 mb-3 font-semibold">Enter your VPN server credentials</p>
            <form onSubmit={saveAndConnectVpn} className="space-y-3.5 text-left">
              <div>
                <label className="text-[9px] font-bold text-gray-400 uppercase">Server Address</label>
                <input
                  type="text"
                  required
      ...
      {promptType === "vpn_connect" && (
        <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-gray-200 rounded-xl shadow-2xl p-5 w-80 max-w-full text-center select-none animate-in zoom-in-95 duration-200">
            ...
            <p className="text-[11.5px] text-gray-500 mt-1.5 mb-5 font-medium leading-relaxed">
              Initiate connection to configured VPN server <strong>&ldquo;{vpnConfig?.server}&rdquo;</strong>?
            </p>
            <div className="flex gap-2 justify-end text-[11px]">
              <button
                type="button"
