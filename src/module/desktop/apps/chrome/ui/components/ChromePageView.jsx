...
const ChromePageView = ({
  activeTab, theme, settingsThemeClasses,
  searchEngine, googleSearchQuery, setGoogleSearchQuery,
  navigateTabTo, bookmarks, setBookmarks,
  isGitHubUrl, isLinkedInUrl, isTwitterUrl, isWikipediaUrl,
  isIframeable, isAdBlockerActive, setIsAdBlockerActive,
  isLensScanning, setIsLensScanning,
  showCastDialog, setShowCastDialog,
  castDevice, setCastDevice, isCastConnecting, setIsCastConnecting,
