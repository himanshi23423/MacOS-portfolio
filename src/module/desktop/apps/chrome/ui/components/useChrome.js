...
import {
  DEFAULT_TABS, DEFAULT_BOOKMARKS, DEFAULT_DOWNLOADS,
  DEFAULT_PASSWORDS, DEFAULT_CARDS, DEFAULT_ADDRESSES,
...
const useChrome = () => {
  ...
  const menuThemeClasses = {
    menuBg: theme === "dark" ? "bg-[#282a2d] border-zinc-700/80 text-zinc-100 divide-zinc-700/60 shadow-black/40" : "bg-white border-neutral-200 text-neutral-800 divide-neutral-200 shadow-neutral-300/40",
    itemHover: theme === "dark" ? "hover:bg-white/10" : "hover:bg-neutral-100",
    subBg: theme === "dark" ? "bg-[#282a2d] border-zinc-700/80 text-zinc-200 divide-zinc-700/50 shadow-black/40" : "bg-white border-neutral-200 text-neutral-800 divide-neutral-200 shadow-neutral-300/40",
    ...
    exitBtn: theme === "dark" ? "hover:bg-rose-950/60 hover:text-rose-400 text-rose-300" : "hover:bg-rose-50 hover:text-rose-600 text-rose-500",
  };
    ...
    if (activeTab.historyIndex > 0) {
      setTabs(prevTabs => prevTabs.map(tab => {
        if (tab.id === activeTabId) {
          ...
          return { ...tab, url: nextUrl, historyIndex: nextIndex, title: getTitleForUrl(nextUrl) };
        }
        return tab;
      }));
    }
  ...
  return {
    ...
    googleSearchQuery, setGoogleSearchQuery,
    ...
    findMatchesCount,
    findMatchIndex, setFindMatchIndex,
    showCastDialog, setShowCastDialog,
    castDevice, setCastDevice,
    isCastConnecting, setIsCastConnecting,
    ...
    isIframeable,
    themeClasses, menuThemeClasses, settingsThemeClasses,
  };
};
