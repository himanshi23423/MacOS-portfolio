...
const ChromeBrowserSection = ({
  ...
  <>
      ...
      >
        <div className="max-w-2xl w-full space-y-6">
          ...
          >
            ...
            <div
              className={`flex-1 max-w-md border rounded-full px-4 py-1.5 text-xs flex items-center ${
          ...
          <div className="space-y-6 pt-2">
            <div className="space-y-1">
              ...
              >
                Wikipedia is a free online encyclopedia, created and edited by volunteers around the
    ...
    {/* Refused / Security Sandboxed Site Fallback Card */}
    {activeTab.url !== "chrome://newtab" &&
      !activeTab.url.includes("google.com/search") &&
      !activeTab.url.startsWith("chrome://") &&
      !isGitHubUrl &&
          ...
          <div className="bg-white border border-slate-200/80 p-8 rounded-2xl shadow-lg max-w-md w-full text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                <code className="bg-gray-150 px-1 py-0.5 rounded text-[10px]">X-Frame-Options</code>
                ).
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#161b22] border border-[#30363d] rounded-md p-4 space-y-3 flex flex-col justify-between hover:border-[#8b949e]/50 transition-colors">
                  <div>
                    ...
                    <p className="text-[11px] text-[#8b949e] mt-2 leading-relaxed">
                      Beautiful macos desktop portfolio simulator built with React, Vite and
                      Tailwind. Includes interactive dock, weather, notes, safari, and settings
                      apps.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-[10px] text-[#8b949e]">
                    <span className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-full bg-[#f1e05a]" /> JavaScript
                    </span>
                    <span>{"\u2B50"} 142</span>
                    <span>Fork 28</span>
                  </div>
                ...
                <div className="bg-[#161b22] border border-[#30363d] rounded-md p-4 space-y-3 flex flex-col justify-between hover:border-[#8b949e]/50 transition-colors">
                  <div>
                    ...
                    <p className="text-[11px] text-[#8b949e] mt-2 leading-relaxed">
                      Clean media downloader application for Instagram posts, reels, and highlights.
                      Stateful batch download pipeline.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-[10px] text-[#8b949e]">
                    <span className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-full bg-[#3178c6]" /> TypeScript
                    </span>
                    <span>{"\u2B50"} 89</span>
                    <span>Fork 12</span>
                  </div>
                ...
                <div className="bg-[#161b22] border border-[#30363d] rounded-md p-4 space-y-3 flex flex-col justify-between hover:border-[#8b949e]/50 transition-colors">
                  <div>
                    ...
                    <p className="text-[11px] text-[#8b949e] mt-2 leading-relaxed">
                      AI powered resume screening platform comparing job description keywords
                      against resumes using NLP embeddings.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-[10px] text-[#8b949e]">
                    <span className="flex items-center gap-1">
                      <span className="w-3 h-3 rounded-full bg-[#3572A5]" /> Python
                    </span>
                    <span>{"\u2B50"} 64</span>
                  </div>
                </div>
                ...
                <div className="bg-[#161b22] border border-[#30363d] rounded-md p-4 space-y-3 flex flex-col justify-between hover:border-[#8b949e]/50 transition-colors">
                  <div>
                    ...
                    <p className="text-[11px] text-[#8b949e] mt-2 leading-relaxed">
                      A modern, lightweight YouTube alternative client with ad-blocking and
                      picture-in-picture streaming state support.
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-[10px] text-[#8b949e]">
                    <span className="flex items-center gap-1">
        ...
        <div className="flex-1 max-w-4xl mx-auto w-full p-6 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-3">
            ...
            <p className="text-xs leading-relaxed text-gray-700">
              ...
              building, and launching high-performance interactive web interfaces. Specialized in
              React, JavaScript, Node.js, Bun, Vite, and macOS-style glassmorphic desktop
              simulations. Pushing the boundaries of browser application modeling.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">2022 - Present &bull; 4 yrs</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">2020 - 2022 &bull; 2 yrs</p>
                  <p className="text-xs text-gray-600 mt-2">
                    Built stateful React components, integrated RESTful APIs, optimized asset
                    delivery pipes, and reduced app bundle sizes by 32% using dynamic import
                    bundles.
                  </p>
                </div>
              </div>
          ...
          <div className="divide-y divide-zinc-800">
            <div className="p-4 flex gap-3 hover:bg-zinc-900/35 transition-colors">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5 text-xs">
                  ...
                  <span className="text-zinc-500">@kuldeepdotcom &bull; 2h</span>
                </div>
                <p className="text-xs leading-relaxed text-zinc-200">
                  Just finished building the Light Theme synchronization for my macOS portfolio! The
                  browser settings and dropdowns now transition perfectly based on Chrome's state.{" "}
                  {"\uD83D\uDE80"}
            ...
            <div className="p-4 flex gap-3 hover:bg-zinc-900/35 transition-colors">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5 text-xs">
                  <span className="font-bold text-white">Kuldeep Rajput</span>
                  <span className="text-zinc-500">@kuldeepdotcom &bull; May 25</span>
                </div>
                <p className="text-xs leading-relaxed text-zinc-200">
                  Recursive rendering inside a mock browser in a portfolio? Yes, please. Type your
                  local address in the Chrome app and see it stack! {"\uD83D\uDCBB"}
                  {"\uD83D\uDDA5\uFE0F"} #reactjs #nextjs
                </p>
                <div className="flex justify-between text-[10px] text-zinc-500 pt-2.5 max-w-sm">
                  <span>{"\uD83D\uDCAC"} 9</span>
            ...
            <div className="p-4 flex gap-3 hover:bg-zinc-900/35 transition-colors">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5 text-xs">
                  <span className="font-bold text-white">Kuldeep Rajput</span>
                  <span className="text-zinc-500">@kuldeepdotcom &bull; Jan 12</span>
                </div>
                <p className="text-xs leading-relaxed text-zinc-200">
                  Hello World! Welcome to my macOS portfolio desktop simulation. Built using React,
                  TailwindCSS, and Lucide Icons. Feel free to explore the apps!
                </p>
                <div className="flex justify-between text-[10px] text-zinc-500 pt-2.5 max-w-sm">
                  <span>{"\uD83D\uDCAC"} 12</span>
                  <span>{"\uD83D\uDD01"} 18</span>
    ...
    {isWikipediaUrl && (
      <div
        className="absolute inset-0 bg-white text-gray-900 flex flex-col font-sans select-text overflow-y-auto z-0"
      ...
      >
        ...
        <div className="flex flex-1 gap-0 min-h-0">
          <div className="flex-1 overflow-y-auto p-8 max-w-4xl">
            <h1
              className="text-3xl font-normal border-b border-gray-300 pb-3 mb-4"
              style={{ fontFamily: "'Linux Libertine', Georgia, serif" }}
            >
        ...
        <div className="max-w-xl w-full text-center space-y-6 -mt-10">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-zinc-400 max-w-md mx-auto leading-relaxed">
              ...
              activity. However, downloads and bookmarks will be saved.
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 grid grid-cols-2 gap-6 max-w-4xl">
          ...
          >
            <div className="space-y-2">
              ...
              <p className={`text-[10px] ${settingsThemeClasses.textMuted} leading-relaxed`}>
                ...
                across all websites inside the portfolio browser.
              </p>
            </div>
            <div
          ...
          >
            <div className="space-y-2">
              ...
              <p className={`text-[10px] ${settingsThemeClasses.textMuted} leading-relaxed`}>
                Adds React component debugging tools and state inspector consoles to the browser
      ...
      <div className="absolute inset-0 bg-[#202124] text-gray-200 flex select-none overflow-hidden font-mono">
        <div className="w-1/2 border-r border-[#3c3e41] flex flex-col p-4 space-y-3 overflow-y-auto">
          ...
          <div className="text-[11px] text-sky-400 space-y-1">
            ...
            <div className="pl-8">
              &lt;<span className="text-pink-400">div</span>{" "}
              <span className="text-purple-400">id</span>="dock"&gt;...&lt;/
              <span className="text-pink-400">div</span>&gt;
            </div>
            <div className="pl-4">
              &lt;/<span className="text-pink-400">main</span>&gt;
...
export default ChromeBrowserSection;
