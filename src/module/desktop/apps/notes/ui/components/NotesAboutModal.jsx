...
const NotesAboutModal = ({ show, onClose }) => {
  if (!show) return null;
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-3 text-center">
          ...
          />
          <h1 className="text-base font-bold text-gray-900 mt-3 select-none">Notes</h1>
          <p className="text-[10px] text-gray-500 font-medium select-none mt-0.5">
            Version 4.11 (Ventura)
          </p>
        </div>
...
export default NotesAboutModal;
