const MOCK_COLLECTIONS = [
  {
    ...
    requests: [
      ...
      { id: "req_update_profile", name: "Update Profile", method: "PUT", url: "https://api.dev/v1/profile", body: '{\n  "name": "Kuldeep Rajput",\n  "role": "Senior Full Stack Engineer",\n  "location": "Mumbai, India"\n}' },
      { id: "req_login", name: "User Login", method: "POST", url: "https://api.dev/v1/login", body: '{\n  "username": "guest",\n  "password": "password123"\n}' },
      { id: "req_logout", name: "User Logout", method: "DELETE", url: "https://api.dev/v1/logout", body: "" }
    ]
  },
  {
    name: "Portfolio API",
    requests: [
      ...
      { id: "req_stats", name: "Get Portfolio Stats", method: "GET", url: "https://api.dev/v1/stats", body: "" },
