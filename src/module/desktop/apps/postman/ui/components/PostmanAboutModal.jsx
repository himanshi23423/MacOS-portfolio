...
const PostmanAboutModal = ({ show, onClose }) => {
  if (!show) return null;
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-3 text-center">
          ...
          />
          <h1 className="text-base font-bold text-gray-900 mt-3 select-none">Postman</h1>
          <p className="text-[10px] text-gray-500 font-medium select-none mt-0.5">
            Version 11.2 (Agent Client)
          </p>
        </div>

        {/* Footer/Copyright */}
        <div className="text-center text-[8.5px] text-gray-400/90 leading-tight mb-2 select-none font-sans">
          <p>Copyright © 2014-2026 Postman Inc.</p>
...
export default PostmanAboutModal;
